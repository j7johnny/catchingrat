    ...
    group_definitions = [
        ...
        },
        {
            ...
            "fields": (
                ...
                "enable_char_to_pinyin",
                "char_to_pinyin_ratio",
                "enable_char_reverse",
                "char_reverse_ratio",
                "reverse_rotation_min",
                "reverse_rotation_max",
            ),
        },
        {
            "title": "桌機版面",
            ...
            "fields": (
                ...
                "desktop_canvas_margin",
                "desktop_canvas_supersample",
                "desktop_max_chars_per_line",
                "desktop_line_height_multiplier",
                "desktop_micro_kerning_jitter",
                "desktop_baseline_jitter",
                "desktop_character_scale_jitter",
                "desktop_min_size",
                "desktop_max_size",
                "desktop_background_density",
            ),
        },
        {
            "title": "手機版面",
            ...
            "fields": (
                ...
                "mobile_canvas_margin",
                "mobile_canvas_supersample",
                "mobile_max_chars_per_line",
                "mobile_line_height_multiplier",
                "mobile_micro_kerning_jitter",
                "mobile_baseline_jitter",
                "mobile_character_scale_jitter",
                "mobile_min_size",
                "mobile_max_size",
                "mobile_background_density",
            ),
        },
        {
            "title": "背景與色彩",
            ...
            "fields": (
                ...
                "canvas_dpi",
                "background_enable",
                "background_min_font_size",
                "background_max_font_size",
        ...
        },
        {
            ...
            "fields": (
                "fragment_enable",
                "stroke_fragmentation_prob",
                "closed_structure_break_prob",
                "closed_structure_chars",
                "erase_width",
                "erase_ratio",
        ...
        },
        {
            ...
            "fields": (
                ...
                "edge_brightness_noise",
                "local_contrast_noise",
                "local_contrast_patches",
                "adversarial_watermark_enable",
                "watermark_text",
                "watermark_opacity",
                "watermark_density",
                "watermark_scale",
    ...
    def clean(self):
        ...
        shared_config = {
            "text": {
                ...
                "reverse_rotation_range": [
                    cleaned_data["reverse_rotation_min"],
                    cleaned_data["reverse_rotation_max"],
                ],
            },
            "canvas": {
