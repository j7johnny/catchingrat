...
VISIBLE_WATERMARK_DELTA_L = env_int("VISIBLE_WATERMARK_DELTA_L", -2)
VISIBLE_WATERMARK_DELTA_A = env_int("VISIBLE_WATERMARK_DELTA_A", 20)
VISIBLE_WATERMARK_DELTA_B = env_int("VISIBLE_WATERMARK_DELTA_B", -22)
VISIBLE_WATERMARK_BACKGROUND_THRESHOLD = env_int("VISIBLE_WATERMARK_BACKGROUND_THRESHOLD", 150)
VISIBLE_WATERMARK_DESKTOP_FONT_SIZE = env_int("VISIBLE_WATERMARK_DESKTOP_FONT_SIZE", 20)
VISIBLE_WATERMARK_MOBILE_FONT_SIZE = env_int("VISIBLE_WATERMARK_MOBILE_FONT_SIZE", 18)
VISIBLE_WATERMARK_DESKTOP_ROW_SPACING = env_int("VISIBLE_WATERMARK_DESKTOP_ROW_SPACING", 46)
VISIBLE_WATERMARK_MOBILE_ROW_SPACING = env_int("VISIBLE_WATERMARK_MOBILE_ROW_SPACING", 40)
VISIBLE_WATERMARK_TEXT_GAP = env_int("VISIBLE_WATERMARK_TEXT_GAP", 16)
VISIBLE_WATERMARK_MASK_OPACITY = env_float("VISIBLE_WATERMARK_MASK_OPACITY", 1.0)
VISIBLE_WATERMARK_MASK_BLUR = env_float("VISIBLE_WATERMARK_MASK_BLUR", 0.45)
