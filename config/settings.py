...
VISIBLE_WATERMARK_DESKTOP_FONT_SIZE = env_int("VISIBLE_WATERMARK_DESKTOP_FONT_SIZE", 15)
VISIBLE_WATERMARK_MOBILE_FONT_SIZE = env_int("VISIBLE_WATERMARK_MOBILE_FONT_SIZE", 13)
VISIBLE_WATERMARK_DESKTOP_ROW_SPACING = env_int("VISIBLE_WATERMARK_DESKTOP_ROW_SPACING", 64)
VISIBLE_WATERMARK_MOBILE_ROW_SPACING = env_int("VISIBLE_WATERMARK_MOBILE_ROW_SPACING", 56)
VISIBLE_WATERMARK_TEXT_GAP = env_int("VISIBLE_WATERMARK_TEXT_GAP", 52)
...
VISIBLE_WATERMARK_BLUE_BITS = env_int("VISIBLE_WATERMARK_BLUE_BITS", 2)
VISIBLE_WATERMARK_GREEN_BITS = env_int("VISIBLE_WATERMARK_GREEN_BITS", 1)
